...
oid1=netsnmp.VarList(netsnmp.Varbind(".1.3.6.1.4.1.4491.2.1.28.1.5.1.1"))
result=session.walk(oid1)

print("printing result of pre- total codewords")
print(result)
...
oid2=netsnmp.VarList(netsnmp.Varbind(".1.3.6.1.4.1.4491.2.1.28.1.5.1.2"))
...
oid3=netsnmp.VarList(netsnmp.Varbind(".1.3.6.1.4.1.4491.2.1.28.1.5.1.3"))
