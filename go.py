...
print "There are ", h, " registered modems\n\n"
...
# write total codewords in third column of matrix to be used for .csv file
...
# write corrected codewords in fourth column of matrix to be used for .csv file
for i, item in enumerate(result2, start=0):
    matrix[i][3]=item


#wirte corrected codewords to local file
...
# write unreliable codewords to fifth column of matrix to be used for .csv file
for i, item in enumerate(result3, start=0):
    matrix[i][4] = item


# write corrected codewords to local file.
